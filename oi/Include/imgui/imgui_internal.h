...
enum ImGuiItemStatusFlags_
{
    ...
    ImGuiItemStatusFlags_FocusedByTabbing   = 1 << 10,   // Set when the Focusable item just got focused by Tabbing (FIXME: to be removed soon)
...
//#endif
    ...
    IMGUI_API bool          NewBeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags);
    ...
    IMGUI_API bool          Tab(bool selected, const char* label, const ImVec2& size_arg);
    IMGUI_API bool          SubTab(bool selected, const char* label, ImVec2 size_arg, bool useBase = false, float w = 0);
    IMGUI_API bool          NewCheckbox(const char* label, bool* v);
    IMGUI_API bool          NewCheckboxType(const char* label, bool* v);
    IMGUI_API bool          NewCheckboxOnLeft(const char* label, bool* v);
    ...
    IMGUI_API bool          NewInputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
