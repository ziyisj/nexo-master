...
#if defined(PLATFORM_ARM64) && !defined(ARM64_INSERT_VIA_INLINE)

#define VM_TIGER_WHITE_START CustomVM00000178_Start();
#define VM_TIGER_WHITE_END CustomVM00000178_End();

#define VM_TIGER_RED_START CustomVM00000179_Start();
#define VM_TIGER_RED_END CustomVM00000179_End();

#define VM_TIGER_BLACK_START CustomVM00000180_Start();
#define VM_TIGER_BLACK_END CustomVM00000180_End();

#define VM_FISH_WHITE_START CustomVM00000181_Start();
#define VM_FISH_WHITE_END CustomVM00000181_End();

#define VM_FISH_RED_START CustomVM00000182_Start();
#define VM_FISH_RED_END CustomVM00000182_End();

#define VM_FISH_BLACK_START CustomVM00000183_Start();
#define VM_FISH_BLACK_END CustomVM00000183_End();

#define VM_PUMA_WHITE_START CustomVM00000184_Start();
#define VM_PUMA_WHITE_END CustomVM00000184_End();

#define VM_PUMA_RED_START CustomVM00000185_Start();
#define VM_PUMA_RED_END CustomVM00000185_End();

#define VM_PUMA_BLACK_START CustomVM00000186_Start();
#define VM_PUMA_BLACK_END CustomVM00000186_End();

#define VM_SHARK_WHITE_START CustomVM00000187_Start();
#define VM_SHARK_WHITE_END CustomVM00000187_End();

#define VM_SHARK_RED_START CustomVM00000188_Start();
#define VM_SHARK_RED_END CustomVM00000188_End();

#define VM_SHARK_BLACK_START CustomVM00000189_Start();
#define VM_SHARK_BLACK_END CustomVM00000189_End();

#define VM_FISH_EXTREME_START CustomVM00000190_Start();
#define VM_FISH_EXTREME_END CustomVM00000190_End();

#define VM_TIGER_EXTREME_START CustomVM00000191_Start();
#define VM_TIGER_EXTREME_END CustomVM00000191_End();

#define VM_FISH_LITE_START CustomVM00000192_Start();
#define VM_FISH_LITE_END CustomVM00000192_End();

#define VM_FISH_LONDON_START CustomVM00000193_Start();
#define VM_FISH_LONDON_END CustomVM00000193_End();

#define VM_TIGER_LONDON_START CustomVM00000194_Start();
#define VM_TIGER_LONDON_END CustomVM00000194_End();

#define VM_DOLPHIN_WHITE_START CustomVM00000195_Start();
#define VM_DOLPHIN_WHITE_END CustomVM00000195_End();

#define VM_DOLPHIN_RED_START CustomVM00000196_Start();
#define VM_DOLPHIN_RED_END CustomVM00000196_End();

#define VM_DOLPHIN_BLACK_START CustomVM00000197_Start();
#define VM_DOLPHIN_BLACK_END CustomVM00000197_End();

#define VM_EAGLE_WHITE_START CustomVM00000201_Start();
#define VM_EAGLE_WHITE_END CustomVM00000201_End();

#define VM_EAGLE_RED_START CustomVM00000202_Start();
#define VM_EAGLE_RED_END CustomVM00000202_End();

#define VM_EAGLE_BLACK_START CustomVM00000203_Start();
#define VM_EAGLE_BLACK_END CustomVM00000203_End();

#define VM_TIGER_LITE_START CustomVM00000207_Start();
#define VM_TIGER_LITE_END CustomVM00000207_End();

#define VM_LION_WHITE_START CustomVM00000208_Start();
#define VM_LION_WHITE_END CustomVM00000208_End();

#define VM_LION_RED_START CustomVM00000209_Start();
#define VM_LION_RED_END CustomVM00000209_End();

#define VM_LION_BLACK_START CustomVM00000210_Start();
#define VM_LION_BLACK_END CustomVM00000210_End();

#define VM_COBRA_WHITE_START CustomVM00000211_Start();
#define VM_COBRA_WHITE_END CustomVM00000211_End();

#define VM_COBRA_RED_START CustomVM00000212_Start();
#define VM_COBRA_RED_END CustomVM00000212_End();

#define VM_COBRA_BLACK_START CustomVM00000213_Start();
#define VM_COBRA_BLACK_END CustomVM00000213_End();

#define VM_WOLF_WHITE_START CustomVM00000214_Start();
#define VM_WOLF_WHITE_END CustomVM00000214_End();

#define VM_WOLF_RED_START CustomVM00000215_Start();
#define VM_WOLF_RED_END CustomVM00000215_End();

#define VM_WOLF_BLACK_START CustomVM00000216_Start();
#define VM_WOLF_BLACK_END CustomVM00000216_End();

#define VM_MUTATE_ONLY_START Mutate_Start();
#define VM_MUTATE_ONLY_END Mutate_End();

#define VM_FALCON_TINY_START CustomVM00000219_Start();
#define VM_FALCON_TINY_END CustomVM00000219_End();
